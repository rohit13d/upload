...
function add_data()
{
	var article_data={article_title:"",article_keywords:"",article_name:"",article_type:"",article_theme:""};
	...
	$.ajax({
           ...
           url: "http://localhost/codeignitor/upload/assets/webservice/insert_article.php",
		   dataType:"json",
           crossDomain : true,
           //async:false,
           type:'POST',		   
